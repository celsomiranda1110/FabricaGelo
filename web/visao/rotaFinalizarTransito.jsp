<%-- 
    Document   : rotaFinalizarTransito
    Created on : 08/02/2019, 09:04:29
    Author     : celso
--%>
        ...
        <form name="formRotaFinalizar" method="post">
            <div class="container">
                <div class="panel panel-default">
                    <div class="panel-heading"><div class="panel-title text-center"><h3><b>Finalizar rota</b></h3></div></div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="txtKmFinal" id="txtKmFinal"> 
                                    </div>
